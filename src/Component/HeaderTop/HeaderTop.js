                                ...
                                <div className="header__qr">
                                    ...
                                    <div className="header__qr-apps">
                                        <a href="http://" className>
                                            <img src="./asset/img/googlePlay.png" alt className="header__qr-download-img" />
                                        </a>
                                        <a href="http://" className>
                                            <img src="./asset/img/appStore.png" alt className="header__qr-download-img" /></a>
                                    </div>
                                </div>
                            </li>
                            <li className="header__navbar-item">
                                <span className="header__navbar-title--no-pointer ">Kết nối</span>
                                <a href="#" className="header__navbar-icon-link has-hover"><i className="header__navbar-icon fab fa-facebook " /></a>
                                <a href="#" className="header__navbar-icon-link has-hover"><i className="header__navbar-icon fab fa-instagram " /></a>
                            </li>
                        </ul>
                        <ul className="header__navbar-list">
                            <HeaderNotify/>
                            <li className="header__navbar-item">
                                <a href="#" className="header__navbar-item-link  has-hover">
                                    <i className="far fa-question-circle" />
                                      Trợ giúp
                                </a>
                            </li>
                            <li className="header__navbar-item "><a href="./register.html" className="header__navbar-item-link header__navbar-item-link--strong header__navbar-item--separate has-hover">Đăng kí</a></li>
                            <li className="header__navbar-item "><a href="./login.html" className="header__navbar-item-link header__navbar-item-link--strong has-hover">Đăng nhập</a></li>
                            ...
                            <div className="header__search-select">
                                ...
                                <ul className="header__search-option">
                                    <li className="header__search-option-item header__search-option-item--active">
                                        <span className>Trong shop</span>
                                        <i className="fas fa-check" />
                                    </li>
                                    <li className="header__search-option-item">
                                        <span className>Ngoài shop</span>
                                        <i className="fas fa-check" />
                                    </li>
                                </ul>
                            </div>
